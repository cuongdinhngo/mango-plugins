# PROJ-714 — Build the customer mobile app

**Requirement:** Build a new customer-facing mobile app: onboarding / login, a home dashboard, a
notifications centre, and account settings.
...
Testable), and **holds a human gate — the human ratifies the split BEFORE any ticket executes.** Each
ratified ticket then runs its own full lifecycle.
